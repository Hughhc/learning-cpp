...
cope_constructor::CGirl::CGirl() { m_name.clear(); m_age = 0; cout << "调用了CGirl构造函数" << endl; }

cope_constructor::CGirl::CGirl(const CGirl& g, int i) { m_name = "漂亮的" + g.m_name; m_age = g.m_age - i; cout << "调用了CGirl(const CGirl& g,int i)拷贝构造函数" << endl; }

cope_constructor::CGirl::~CGirl() { cout << "调用了~CGirl()\n"; }

void cope_constructor::CGirl::show() { cout << "姓名：" << m_name << "，年龄：" << m_age << endl; }
